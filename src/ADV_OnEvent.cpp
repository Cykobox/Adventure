	...
	switch (GFXMODE::GFXMODE_Control.GET_GFX_MODE()) {
          case (GFX_MODE_PC): {
               switch (Scan_Code) {
					...
					case SDL_SCANCODE_G: Player1.CUR_HP = Player1.CUR_HP - 10; break;
					...
					case SDLK_KP_2:{  //action button. At some point this needs to be moved so that any key can be assigned as the action button.
